...
import x10.lang.*;
import x10.util.*;
//import x10.util.concurrent.ConcurrentSkipListMap;
...
public class ConcurrentSkipListSet [E] extends AbstractSet[E]
     ...
     */
    private val m: ConcurrentNavigableMap[E,Object];
...
//        addAll(s);
    ...
    public def clone() : ConcurrentSkipListSet[E] {
        ...
        } catch (e: UnsupportedOperationException) {    // CloneNotSupportedException
    ...
    public def removeAll(c: Collection[Object]) : Boolean {
        ...
        for (var i: Iterator[Object] = c.iterator(); i.hasNext(); )
            if (remove(i.next()))
                modified = true;
        return modified;
    } */
