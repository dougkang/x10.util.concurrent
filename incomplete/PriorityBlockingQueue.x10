...
public class PriorityBlockingQueue[E] extends AbstractQueue[E]
    ...
    //private val ReentrantLock lock = new ReentrantLock(true);
    //private val Condition notEmpty = lock.newCondition();
     ...
     */
    /*
    public def offer(e: E, timeout: long, unit: TimeUnit) : Boolean {
    ...
    public def take() : E throws UnsupportedOperationException { //InterruptedException {
        //final ReentrantLock lock = this.lock;
        ...
        try {
            try {
                while (q.size() == 0)
                    notEmpty.await();
            } catch (ie: UnsupportedOperationException) { //(InterruptedException ie) {
