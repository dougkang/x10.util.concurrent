 ...
 **/
 public class ConcurrentLinkedQueue[E] {
   ...
   **/
  public atomic def add(e:E):Boolean { return offer(e); }
   ...
   **/
  public def isEmpty():Boolean { return first() == null; }
   ...
   **/
   public atomic def size():int { return size; }
   ...
   **/
   public def contains(o:E):Boolean {
     for (var p:Node[E]! = first(); p != null; p = p.getNext()) {
       ...
       if (item != null && o.equals(item.value)) {
    	   return true;
       }
     }
     return false;
